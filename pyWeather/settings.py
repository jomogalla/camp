...
DATABASES = {
    'default': {
        'ENGINE': os.environ.get('DATABASE_ENGINE', ''), # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
...
# STATIC_ROOT = '/home/j/Dropbox/pyWeather_production/pyWeather/weather/static/'
...
SECRET_KEY = 'y_03_8+hvrod51foskj8jh@+3k=zi6@tu3=@uvc_6@hnxvx-s$'
...
#     # Always use forward slashes, even on Windows.
#     # Don't forget to use absolute paths, not relative paths.
#     "/home/j/Dropbox/pyWeather_production/pyWeather/templates"
